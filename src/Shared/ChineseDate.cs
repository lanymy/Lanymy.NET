...
//	///-------------------------------------------------------------------------------
//	///调用:
//	///ChineseDate c = new ChineseDate(new DateTime(1990, 01, 15));
...
//		private const int MAX_YEAR = 2050;
//		private readonly static DateTime MIN_DAY = new DateTime(1900, 1, 30);
//		private readonly static DateTime MAX_DAY = new DateTime(2049, 12, 31);
//		private const int GAN_ZHI_START_YEAR = 1864; //干支计算起始年
//		private readonly static DateTime GAN_ZHI_START_DAY = new DateTime(1899, 12, 22);//起始日
//		private const string HZNum = "零一二三四五六七八九";
//		private const int ANIMAL_START_YEAR = 1900; //1900年为鼠年  
//		private readonly static DateTime CHINESE_CONSTELLATION_REFER_DAY = new DateTime(2007, 9, 13);//28星宿参考值,本日为角
//		#endregion
...
//		private static int[] TermInfo = new int[] { 0, 21208, 42467, 63836, 85337, 107014, 128867, 150921, 173149, 195551, 218072, 240693, 263343, 285989, 308563, 331033, 353350, 375494, 397447, 419210, 440795, 462224, 483532, 504758 };
//		#endregion
...
//		#region 按公历计算的节日
//		private static readonly IReadOnlyList<SolarCalendarHolidayModel> SolarCalendarHolidayList = SolarCalendarHolidayModel.GetSolarCalendarHolidayList();
//		#endregion

//		#region 按农历计算的节日
//		private static readonly IReadOnlyList<LunarCalendarHolidayModel> LunarCalendarHolidayList = LunarCalendarHolidayModel.GetLunarCalendarHolidayList();
//		#endregion

//		#region 按某月第几个星期几
//		private static readonly IReadOnlyList<MonthWeekHolidayModel> MonthWeekHolidayList = MonthWeekHolidayModel.GetMonthWeekHolidayList();
//		#endregion
//		#endregion
...
//			//计算两天的基本差距
//			TimeSpan ts = _Date - ChineseDate.MIN_DAY;
//			offset = ts.Days;
...
//		{
//			if (BitTest32((LunarDateArray[year - MIN_YEAR] & 0x0000FFFF), (16 - month)))
//			{
//				return 30;
//			}
//			else
...
//		{
//			return LunarDateArray[year - MIN_YEAR] & 0xF;
//		}
//		#endregion
...
//			{
//				if ((LunarDateArray[year - MIN_YEAR] & 0x10000) != 0)
//				{
//					return 30;
//				}
//				else
...
//			sumDay = 348; //29天*12个月
//			i = 0x8000;
//			info = LunarDateArray[year - MIN_YEAR] & 0x0FFFF;
...
//			//计算天干
//			TimeSpan ts = this._Date - GAN_ZHI_START_DAY;
//			i = ts.Days % 60;
...
//				{
//					foreach (var lh in LunarCalendarHolidayList)
//					{
...
//			{
//				string tempStr = "";
//				foreach (var wh in MonthWeekHolidayList)
//				{
...
//				foreach (var sh in SolarCalendarHolidayList)
//				{
...
//				TimeSpan ts = this._Date - CHINESE_CONSTELLATION_REFER_DAY;
//				offset = ts.Days;
...
//			get
//			{
//				int offset = _Date.Year - ANIMAL_START_YEAR;
//				return (offset % 12) + 1;
//			}
//		}
//		#endregion
...
//			get
//			{
//				int offset = _Date.Year - ANIMAL_START_YEAR; //阳历计算
...
//			{
//				string tempStr;
//				int i = (this._CYear - GAN_ZHI_START_YEAR) % 60; //计算干支
...
//		//        //计算两天的基本差距
//		//        TimeSpan ts = _Date - ChineseCalendar.MIN_DAY;
//		//        offset = ts.Days;

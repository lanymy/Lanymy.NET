...
namespace Lanymy.General.Extension
{
    ...
    public class ArrayFunctions
    {
        ...
        {
            return GenericityFunctions.GetInterface(arrayExtension, DefaultArrayExtension).MergerArray(firstArray, secondArray, arrayParams);
        }
        ...
        public static T[] SubArray<T>(T[] sourceArray, int startIndex, int length = 0, IArrayExtension arrayExtension = null)
        {
            ...
            return GenericityFunctions.GetInterface(arrayExtension, DefaultArrayExtension).SubArray(sourceArray, startIndex, length);
        ...
        {
            return GenericityFunctions.GetInterface(arrayExtension, DefaultArrayExtension).ArrayEquals(firstArray, secondArray);
        }
        ...
        {
            return GenericityFunctions.GetInterface(arrayExtension, DefaultArrayExtension).GetSubsetIndex(source, subset);
        }
        ...
        {
            return GenericityFunctions.GetInterface(arrayExtension, DefaultArrayExtension).IsSubset(source, subset);
        }

...
namespace Lanymy.General.Extension.Instruments
{
    ...
    public class LanymyIsolatedStorage: BaseIsolatedStorage
    {
        ...
        {
            return Path.Combine(PathFunctions.GetCallDomainPath(), CUSTOM_ISOLATED_STORAGE_ROOT_DIRECTORY_NAME);
        }
        ...
        {
            return SecurityFunctions.EncryptFileNameToBase64String(fileName, ISOLATED_STORAGE_FILE_SUFFIX, null, false);
        }

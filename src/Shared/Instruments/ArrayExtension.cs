...
namespace Lanymy.General.Extension.Instruments
{
    ...
    /// 数组扩展方法类
    /// </summary>
    public class ArrayExtension: IArrayExtension
    {
        ...
        /// <returns></returns>
        public virtual T[] MergerArray<T>(T[] firstArray, T[] secondArray, params T[][] arrayParams)
        {
        ...
        /// <returns></returns>
        public virtual T[] SubArray<T>(T[] sourceArray, int startIndex, int length = 0)
        {
        ...
        /// <param name="secondArray"></param>
        /// <returns></returns>
        public virtual bool ArrayEquals<T>(T[] firstArray, T[] secondArray)
        {
        ...
        /// <returns></returns>
        public virtual int GetSubsetIndex(byte[] source, byte[] subset)
        {
        ...
        /// <param name="subset"></param>
        /// <returns></returns>
        public virtual bool IsSubset(byte[] source, byte[] subset)
        {

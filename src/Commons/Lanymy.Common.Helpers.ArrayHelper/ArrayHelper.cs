...
namespace Lanymy.Common.Helpers
{
    ...
    public class ArrayHelper
    {
        ...
        /// 默认数组辅助方法
        /// </summary>
        public static readonly IArrayManipulater DefaultArrayExtension = new ArrayManipulater();
        ...
        /// <param name="arrayExtension">null 则使用默认数组扩展方法</param>
        /// <returns></returns>
        public static int GetSubsetIndex(byte[] source, byte[] subset, IArrayManipulater arrayExtension = null)
        {

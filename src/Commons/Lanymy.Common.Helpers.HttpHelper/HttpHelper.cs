...
using Lanymy.Common.Abstractions.Models.AttachmentInfoModels;
...
namespace Lanymy.Common.Helpers
{
    ...
    public class HttpHelper
    {
        ...
        {
            return await HttpPostAsync<TReturnDataModel>(url, JsonSerializeHelper.SerializeToJson(postDataModel));
        }
        ...
        public static async Task<string> HttpPostAsync<TPostDataModel>(string url, TPostDataModel postDataModel) where TPostDataModel : class
        {
            ...
            return await HttpPostAsync(url, JsonSerializeHelper.SerializeToJson(postDataModel));
